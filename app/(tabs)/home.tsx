        ...
        <BottomSheet
          ...
          <View style={tailwind.style('pt-4 px-3')}>
            <View style={tailwind.style('justify-between items-center flex-row')}>
              <View>
                  <Text style={tailwind.style('text-gray-300 text-xs',{})}>
                      Good afternoon
                  </Text>
              ...
              <View style={tailwind.style('flex-row items-center items-center')}>
                  <Image
                      source={require('@/assets/images/photo-5.png')}
                      style={tailwind.style('w-7 h-7 mr-2.5',{ objectFit: 'contain' })}
                  />
                  <Image
            ...
            <View style={tailwind.style('mt-3')}>
              <Image
                ...
                style={tailwind.style('w-full h-18')}
                resizeMode="contain"
              />
            </View>
            <View>
            ...
            <View>
            <View style={tailwind.style('py-3 px-5 flex-row justify-between items-center items-center bg-[#1E1E1E] rounded-t-2xl')}>
              <Text style={tailwind.style('text-xs text-gray-400 text-sm uppercase')}>Recent Tansactions</Text>
                <Image
                  source={require('@/assets/images/arrow-left.png')}
                  style={tailwind.style('w-5 h-5',{ objectFit: 'contain' })}
                />
            </View>
            <View style={tailwind.style('py-4 px-4 bg-[#181818] rounded-b-2xl')}>
              {/*First*/}
              <View style={tailwind.style('justify-between items-center flex-row')}>
                <View style={tailwind.style('flex-row items-center')}>
                  ...
                  <View style={tailwind.style('pl-2')}>
                    <Text style={tailwind.style('text-sm text-white')}>Sanda King-David Ayodele</Text>
                    <Text style={tailwind.style('text-xs text-gray-400')}>Transfer</Text>
                  </View>
                </View>
                <Text style={tailwind.style('text-sm text-white')}>₦ 2,999.00</Text>
              </View>

              {/*Second*/}
              <View style={tailwind.style('mt-4 justify-between items-center flex-row')}>
                <View style={tailwind.style('flex-row items-center')}>
                  <View  style={tailwind.style('relative')}>
                      <Image
                  ...
                  <View style={tailwind.style('pl-2')}>
                    <Text style={tailwind.style('text-sm text-white')}>Bayo Adekunle</Text>
                    <Text style={tailwind.style('text-xs text-gray-400')}>Transfer</Text>
                  </View>
                </View>
                <Text style={tailwind.style('text-sm text-white')}>₦ 230,800.00</Text>
              </View>

              {/*Third*/}
              <View style={tailwind.style('mt-5 justify-between items-center flex-row')}>
                <View style={tailwind.style('flex-row items-center')}>
                  <View  style={tailwind.style('relative')}>
                      <Image
                        source={require('@/assets/images/photo-13.png')}
                  ...
                  <View style={tailwind.style('pl-2')}>
                    <Text style={tailwind.style('text-sm text-white')}>Simi Adegunle</Text>
                    <Text style={tailwind.style('text-xs text-gray-400')}>Transfer</Text>
                  </View>
                </View>
                <Text style={tailwind.style('text-sm text-white')}>₦ 230,000.00</Text>
              </View>
            </View>
            </View>

            <View style={tailwind.style('mt-3')}>
            <View style={tailwind.style('py-3.5 px-5 flex-row justify-between items-center items-center bg-[#1E1E1E] rounded-t-2xl')}>
              <Text style={tailwind.style('text-xs text-gray-400 text-sm uppercase')}>Beneficiaries</Text>
                <Image
                  source={require('@/assets/images/arrow-left.png')}
                  style={tailwind.style('w-5 h-5',{ objectFit: 'contain' })}
                />
            </View>
            <View style={tailwind.style('py-5 px-4 flex-row items-center bg-[#181818] rounded-b-2xl')}>
                <View style={tailwind.style('items-center mr-5')}>
                  <Image
                    source={require('@/assets/images/photo-6.png')}
                    style={tailwind.style('rounded-full w-14 h-14',{ objectFit: 'contain' })}
                  />
                  <Text style={tailwind.style('text-sm text-white mt-2')}>Josh</Text>
                </View>
                <View style={tailwind.style('items-center mr-5')}>
                  <Image
                    ...
                    style={tailwind.style('rounded-full w-14 h-14',{ objectFit: 'contain' })}
                  />
                  <Text style={tailwind.style('text-sm text-white mt-2')}>Ife</Text>
                </View>
                <View style={tailwind.style('items-center mr-5')}>
                  <Image
                    ...
                    style={tailwind.style('rounded-full w-14 h-14',{ objectFit: 'contain' })}
                  />
                  <Text style={tailwind.style('text-sm text-white mt-2')}>King-David</Text>
                </View>
                <TouchableOpacity style={tailwind.style('items-center bg-[#242C30] rounded-full p-2')}>
                  <Image
                    source={require('@/assets/images/add.png')}
                    style={tailwind.style('rounded-full w-9 h-9',{ objectFit: 'contain' })}
                  />
                </TouchableOpacity>
            </View>
            </View>
